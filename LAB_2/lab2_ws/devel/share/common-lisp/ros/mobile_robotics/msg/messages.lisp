...
(cl:in-package mobile_robotics-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <messages>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'messages)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mobile_robotics-msg:<messages> is deprecated: use mobile_robotics-msg:messages instead.")))

(cl:ensure-generic-function 'seq-val :lambda-list '(m))
(cl:defmethod seq-val ((m <messages>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mobile_robotics-msg:seq-val is deprecated.  Use mobile_robotics-msg:seq instead.")
  (seq m))

(cl:ensure-generic-function 'detections-val :lambda-list '(m))
(cl:defmethod detections-val ((m <messages>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mobile_robotics-msg:detections-val is deprecated.  Use mobile_robotics-msg:detections instead.")
  (detections m))
